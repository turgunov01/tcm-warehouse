      ...
      <UCard>
        ...
        <div class="space-y-3">
          <p class="text-sm text-slate-500">
            Expected columns: email, password, role, full_name, phone, zone_name,
            tenant_code
          </p>
          <UInput
            type="file"
            accept=".xlsx,.xls"
            @change="(event: Event) => file = (event.target as HTMLInputElement).files?.[0] || null"
          />
