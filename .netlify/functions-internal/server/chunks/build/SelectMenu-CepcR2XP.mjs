import { b as __nuxt_component_0, u as useUI, c as useInjectButtonGroup, s as select, d as selectMenu } from './useButtonGroup-Od5NeROe.mjs';
import { resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, renderList, createTextVNode, Transition, defineComponent, toRef, computed, ref, toRaw, watch, watchEffect, nextTick, provide, h as h$1, inject, reactive, useSSRContext, cloneVNode, useId } from 'vue';
import { twJoin } from 'tailwind-merge';
import { _ as _export_sfc, t as twMerge, e as appConfig, h as get, m as mergeConfig } from './server.mjs';
...
import { s as s$2, i as i$4, u as u$2, o as o$1$1, A as A$1, l, b as i$2, p as N, w, r as w$2, v as h, t as t$1, f as f$2, E, e as u$3, T, d as i$2$1, O, n as o$2, j as t$2, m as o$3, x as n$1 } from './active-element-history-CsQcsyjA.mjs';
import { useDebounceFn, computedAsync } from '@vueuse/core';
import { D as defu, R as isEqual } from '../_/nitro.mjs';
...
let ie = /* @__PURE__ */ Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a2, { slots: h$12 }) {
  ...
  w([e$1, c$1, f2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$1(computed(() => u$2(o2.value, { [0]: i$2.Open, [1]: i$2.Closed })));
  computed(() => {
    var t2;
...
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a2, { attrs: h2, slots: r2 }) {
  var e2;
  let y = (e2 = a2.id) != null ? e2 : `headlessui-combobox-label-${i$4()}`, o2 = K("ComboboxLabel");
  function u2() {
    var c2;
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a2, { attrs: h2, slots: r2, expose: y }) {
  var S;
  let o2 = (S = a2.id) != null ? S : `headlessui-combobox-button-${i$4()}`, u2 = K("ComboboxButton");
  ...
  computed(() => i$2$1(o$1$1(e2.inputRef)));
  ...
  function M(i2) {
    switch (w2(() => {
      ...
      case o$2.Enter:
        ...
        break;
      case o$2.ArrowDown:
        return i2.preventDefault(), i2.stopPropagation(), u$2(e2.comboboxState.value, { [0]: () => e2.goToOption(c.Next), [1]: () => e2.openCombobox() });
      case o$2.ArrowUp:
        return i2.preventDefault(), i2.stopPropagation(), u$2(e2.comboboxState.value, { [0]: () => e2.goToOption(c.Previous), [1]: () => {
  ...
  let o2 = K("ComboboxOption"), u2 = `headlessui-combobox-option-${i$4()}`, e2 = ref(null), c$1 = computed(() => a2.disabled);
  y({ el: e2, $el: e2 });
  let f2 = computed(() => {
    var p2;
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r2, emit: w$2$1 }) {
  ...
  w([f2, v], (t2, i2) => {
    var l2;
    k.closeListbox(), w$2(i2, h.Loose) || (t2.preventDefault(), (l2 = o$1$1(f2)) == null || l2.focus());
...
let je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r2, expose: w2 }) {
  ...
  w2({ el: f2, $el: f2 });
  let v = computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false), s2 = computed(() => u$2(e2.mode.value, { [0]: () => e2.compare(toRaw(e2.value.value), toRaw(o2.value)), [1]: () => toRaw(e2.value.value).some((t2) => e2.compare(toRaw(t2), toRaw(o2.value))) }));
  computed(() => u$2(e2.mode.value, { [1]: () => {
    var i2;
...
export { __nuxt_component_6 as _, __nuxt_component_1 as a };
//# sourceMappingURL=SelectMenu-CepcR2XP.mjs.map
