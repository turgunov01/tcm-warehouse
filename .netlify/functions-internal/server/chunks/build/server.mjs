import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, toRef, isRef, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { z as defuFn, A as parseURL, B as encodePath, C as decodePath, D as defu, E as hasProtocol, F as isScriptProtocol, y as joinURL, G as klona, w as withQuery, f as createError$1, H as createDefu, I as sanitizeStatusCode, J as getContext, $ as $fetch$1, K as baseURL, L as createHooks, M as executeAsync, N as getHeader, O as setCookie, P as getRequestHeader, Q as destr, R as isEqual, S as getCookie, T as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-EOzahsVT.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DGCVCE_o.mjs')
  },
  {
    name: "admin-audit",
    path: "/admin/audit",
    component: () => import('./audit-D_KIVzfK.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-BhJ-SN2h.mjs')
  },
  {
    name: "admin-users",
    path: "/admin/users",
    component: () => import('./users-CkDeQB5o.mjs')
  },
  {
    name: "admin-zones",
    path: "/admin/zones",
    component: () => import('./zones-BhAmcmV-.mjs')
  },
  {
    name: "guard",
    path: "/guard",
    component: () => import('./index-D7_SHnz_.mjs')
  },
  {
    name: "tenant",
    path: "/tenant",
    component: () => import('./index-BPraFux5.mjs')
  },
  {
    name: "admin-bookings",
    path: "/admin/bookings",
    component: () => import('./bookings-IuJXEXS4.mjs')
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    component: () => import('./settings-C5GMgG0a.mjs')
  },
  {
    name: "guard-bookings",
    path: "/guard/bookings",
    component: () => import('./bookings-XWALDPiq.mjs')
  },
  {
    name: "tenant-history",
    path: "/tenant/history",
    component: () => import('./history-CU-6C_tH.mjs')
  },
  {
    name: "tenant-profile",
    path: "/tenant/profile",
    component: () => import('./profile-DhO0w1xW.mjs')
  },
  {
    name: "tenant-bookings",
    path: "/tenant/bookings",
    component: () => import('./bookings-BdObRlz_.mjs')
  },
  {
    name: "admin-notifications",
    path: "/admin/notifications",
    component: () => import('./notifications-9IFD1FOT.mjs')
  },
  {
    name: "tenant-notifications",
    path: "/tenant/notifications",
    component: () => import('./notifications-BTwkWBsV.mjs')
  }
];
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
  ...
  const supabase = useSupabaseClient();
  const { user, loadProfile, roleHome } = useAuthRbac();
  let authUser = user.value;
  if (!authUser) {
    const { data } = ([__temp, __restore] = executeAsync(() => supabase.auth.getSession()), __temp = await __temp, __restore(), __temp);
  ...
  const loadedProfile = ([__temp, __restore] = executeAsync(() => loadProfile(authUser.id)), __temp = await __temp, __restore(), __temp);
  if (!loadedProfile) {
...
const LazyIcon = defineAsyncComponent(() => import('./index-CyWm_zZC.mjs').then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const useSupabaseCookieRedirect = () => {
  const config2 = (/* @__PURE__ */ useRuntimeConfig()).public.supabase;
  const prefix = config2.redirectOptions.saveRedirectToCookie ? config2.cookiePrefix : config2.cookieName;
  const cookie = useCookie(
    `${prefix}-redirect-path`,
    {
      ...config2.cookieOptions,
      readonly: false
    }
  );
  return {
  ...
  setup() {
    addRouteMiddleware(
      ...
      /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
        const config2 = (/* @__PURE__ */ useRuntimeConfig()).public.supabase;
        const { login, callback, include, exclude, cookieRedirect, saveRedirectToCookie } = config2.redirectOptions;
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Bn5tyOMl.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B23hBvEO.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DOdpGPrT.mjs'));
...
export { _export_sfc as _, useRoute as a, useSupabaseClient as b, useAuthRbac as c, useState as d, entry_default as default, appConfig as e, useSupabaseUser as f, getSlotsChildren as g, get as h, useRouter as i, encodeRoutePath as j, useNuxtApp as k, looseToNumber as l, mergeConfig as m, navigateTo as n, useRuntimeConfig as o, nuxtLinkDefaults as p, useAppConfig as q, resolveRouteObject as r, omit as s, twMerge as t, useHead as u, asyncDataDefaults as v, createError as w };
